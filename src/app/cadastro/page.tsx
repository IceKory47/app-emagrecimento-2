...
export default function CadastroPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simular cadastro (em produção, conectar com backend)
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-lg font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
              >
                Criar Conta
            ...
            <div className="space-y-3">
              <button className="w-full py-3 border-2 border-gray-300 rounded-lg font-medium hover:bg-gray-50 transition-colors flex items-center justify-center gap-2">
